...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MillenniumPayX server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MillenniumPayX server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MillenniumPayX features */
        {"MillenniumPayX", "masternode", &masternode, true, true, false},
        {"MillenniumPayX", "listmasternodes", &listmasternodes, true, true, false},
        {"MillenniumPayX", "getmasternodecount", &getmasternodecount, true, true, false},
        {"MillenniumPayX", "masternodeconnect", &masternodeconnect, true, true, false},
        {"MillenniumPayX", "masternodecurrent", &masternodecurrent, true, true, false},
        {"MillenniumPayX", "masternodedebug", &masternodedebug, true, true, false},
        {"MillenniumPayX", "startmasternode", &startmasternode, true, true, false},
        {"MillenniumPayX", "createmasternodekey", &createmasternodekey, true, true, false},
        {"MillenniumPayX", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"MillenniumPayX", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"MillenniumPayX", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"MillenniumPayX", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"MillenniumPayX", "getmasternodescores", &getmasternodescores, true, true, false},
        {"MillenniumPayX", "mnbudget", &mnbudget, true, true, false},
        {"MillenniumPayX", "preparebudget", &preparebudget, true, true, false},
        {"MillenniumPayX", "submitbudget", &submitbudget, true, true, false},
        {"MillenniumPayX", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"MillenniumPayX", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"MillenniumPayX", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"MillenniumPayX", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"MillenniumPayX", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"MillenniumPayX", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"MillenniumPayX", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"MillenniumPayX", "checkbudgets", &checkbudgets, true, true, false},
        {"MillenniumPayX", "mnsync", &mnsync, true, true, false},
        {"MillenniumPayX", "spork", &spork, true, true, false},
        {"MillenniumPayX", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"MillenniumPayX", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use MillenniumPayXd, or the -server option to MillenniumPayX-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> MillenniumPayX-cli " + methodname + " " + args + "\n";
}
