                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MillenniumPayX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MillenniumPayX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MillenniumPayX: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MillenniumPayX Core"), this);
    aboutAction->setStatusTip(tr("Show information about MillenniumPayX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MillenniumPayX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MillenniumPayX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MillenniumPayX addresses"));
    ...
    openAction->setStatusTip(tr("Open a MillenniumPayX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MillenniumPayX Core help message to get a list with possible MillenniumPayX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MillenniumPayX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MillenniumPayX network", "", count));
}
...
{
    QString strTitle = tr("MillenniumPayX Core"); // default title
    ...
    // Append title to "MillenniumPayX - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
