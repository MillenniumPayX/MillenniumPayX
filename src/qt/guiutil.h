...
/** Utility functions used by the MillenniumPayX Qt UI.
 */
namespace GUIUtil
{
...
// Render MillenniumPayX addresses in monospace font
...
// Parse "MillenniumPayX:" URI into recipient object, return true on successful parsing
