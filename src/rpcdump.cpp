...
Value importprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"logiscoinprivkey\" ( \"label\" rescan )\n"
            "\nAdds a private key (as returned by dumpprivkey) to your wallet.\n"
            "\nArguments:\n"
            "1. \"logiscoinprivkey\"   (string, required) The private key (see dumpprivkey)\n"
...
Value dumpprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"logiscoinaddress\"\n"
            "\nReveals the private key corresponding to 'logiscoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"logiscoinaddress\"   (string, required) The MillenniumPayX address for the private key\n"
            "\nResult:\n"
...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"logiscoinaddress\"\n"
            "\nEncrypts a private key corresponding to 'logiscoinaddress'.\n"
            "\nArguments:\n"
            "1. \"logiscoinaddress\"   (string, required) The MillenniumPayX address for the private key (you must hold the key already)\n"
