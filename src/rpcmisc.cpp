...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"logiscoinaddress\"\n"
            "\nReturn information about the given MillenniumPayX address.\n"
            "\nArguments:\n"
            "1. \"logiscoinaddress\"     (string, required) The MillenniumPayX address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"logiscoinaddress\", (string) The MillenniumPayX address validated\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"logiscoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"logiscoinaddress\"  (string, required) The MillenniumPayX address to use for the signature.\n"
