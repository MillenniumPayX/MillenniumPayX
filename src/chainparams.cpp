...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 48484;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // MillenniumPayX starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // MillenniumPayX: 1 day
        nTargetSpacing = 1 * 60;  // MillenniumPayX: 1 minute
        nLastPOWBlock = 150;
        nMaturity = 75;
...
/*
        ...
        vSeeds.push_back(CDNSSeedData("80.211.19.47", "80.211.19.47"));         // Single node address
*/
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet MillenniumPayX addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet MillenniumPayX script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet MillenniumPayX BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet MillenniumPayX BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet MillenniumPayX BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // MillenniumPayX: 1 day
        nTargetSpacing = 1 * 60;        // MillenniumPayX: 1 minutes
