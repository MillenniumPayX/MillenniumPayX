...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MillenniumPayX Core MillenniumPayX-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  MillenniumPayX-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MillenniumPayX transaction") + "\n" +
                               "  MillenniumPayX-tx [options] -create [commands]   " + _("Create hex-encoded MillenniumPayX transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MillenniumPayX transaction
