...
In order to support loading of multiple wallets in MillenniumPayX-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is MillenniumPayX.cpp.
...
Changes to MillenniumPayX.cpp
----------------------
MillenniumPayX.cpp is the entry point into MillenniumPayX-qt, and as such, will require some minor modifications to provide hooks for
