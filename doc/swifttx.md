...
This mechanism has been integrated into Bitcore-Node-MillenniumPayX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MillenniumPayX-Project/insight-api-MillenniumPayX#web-socket-api](https://github.com/MillenniumPayX-Project/insight-api-MillenniumPayX#web-socket-api)
* API: [https://github.com/MillenniumPayX-Project/insight-api-MillenniumPayX#swifttx-transactions](https://github.com/MillenniumPayX-Project/insight-api-MillenniumPayX#swifttx-transactions)
...
By default, the MillenniumPayX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MillenniumPayX Core daemon:
